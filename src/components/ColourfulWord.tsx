...
export default function ColourfulWord({guessesArray, todayWord}: ColourfulWordProps): JSX.Element {

return (<div>
{guessesArray.length !== 0 ? (guessesArray.map((word, i) => {
      return (
        <div key={i}>
          {word.split("").map((letter, index) => {console.log(letter);
            return <p
